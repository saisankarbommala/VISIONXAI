      ...
      */}
      ...
      <div className="bg-[#0a041a] text-white min-h-screen py-16 px-4 inter">
        <div className="container mx-auto max-w-4xl text-center">
            ...
            <div className="flex justify-center mt-6">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">1 Sept 2025 – 9:15 AM IST</span>
                </div>
                <div className="flex items-center gap-2">
            ...
            >
              ...
              <ul className="space-y-2 text-gray-300">
                <li className="flex items-start gap-2">
                  ...
                  <span>Teams must consist of maximum <strong>five (3)</strong>  members.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 mt-1">★</span>
          ...
          >
            <a
              href="https://forms.gle/JWu8nuwdAiMqYLf17"
              target="_blank"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-sm md:text-base">
              ...
              <div className="glassmorphism rounded-2xl p-6 space-y-2 glowing-box">
                ...
                <p className="text-cyan-300">+91 89858 93741</p>
