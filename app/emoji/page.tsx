      ...
      */}
      ...
      <div className="bg-[#0a041a] text-white min-h-screen py-16 px-4 inter">
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <a
              href="https://forms.gle/hLaCyvfGRhegVQv36"
              target="_blank"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-sm md:text-base">
              ...
              <div className="glassmorphism rounded-2xl p-6 space-y-2 glowing-box">
                ...
                <p className="text-cyan-300">+91 93472 28811</p>
                <p className="text-cyan-300">+91 95021 97396</p>
          ...
          <p className="mt-16 text-xs text-gray-500">© 2025 Imageverse Competition. All Rights Reserved.</p>
        </div>
      </div>
    </>
  );
