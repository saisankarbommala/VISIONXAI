        ...
        <div className="container mx-auto max-w-4xl text-center">
          ...
          >
            <h1 className="text-5xl md:text-7xl font-bold orbitron holographic-text">
              WEB TASK BUILDER Competition 2025
            </h1>
            ...
            <div className="flex justify-center mt-6">
              ...
              >
                <div className="flex items-center gap-2">
                  ...
                  <span className="font-medium">1 Sept 2025 – 02:30 PM IST</span>
                </div>
                <div className="flex items-center gap-2">
          ...
          <div className="mt-16 glassmorphism rounded-2xl p-6 md:p-10 space-y-8">
            ...
            >
              ...
              <ul className="space-y-2 text-gray-300">
                 <li className="flex items-start gap-2">
                  <span className="text-yellow-400 mt-1">★</span>
                  <span>Each person must carry thier own <strong>Laptop</strong> devices.</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="text-yellow-400 mt-1">★</span>
          ...
          >
            <a
              href="https://forms.gle/BrSKmZupEfhn7Gk87"
              target="_blank"
          ...
          >
            ...
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-center text-sm md:text-base">
              ...
              <div className="glassmorphism rounded-2xl p-6 space-y-2 glowing-box">
                ...
                <p className="text-cyan-300">+91 81252 13332</p>
                <p className="text-cyan-300">+91 99663 60136</p>
              ...
              <div className="glassmorphism rounded-2xl p-6 space-y-2 glowing-box">
                ...
                <p className="text-yellow-300">Aditya Degree College (Co-ed) Gajuwaka</p>
          ...
          <p className="mt-16 text-xs text-gray-500">© 2025 Webcraft Competition. All Rights Reserved.</p>
        </div>
      </div>
    </>
  );
