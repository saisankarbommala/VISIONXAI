      ...
      <section id="events" className="relative min-h-screen py-20 overflow-hidden bg-[#0a041a] text-white inter">
        ...
        <div ref={ref} className="relative z-10 container mx-auto px-4">
          ...
          >
            ...
            >
              Compete in cutting-edge AI challenges and showcase your skills<br></br>
              <h1><strong>Note:- </strong>Each participant may join up to 2 competitions.</h1>
            </motion.p>
          </motion.div>
